                ...
                <div className='mx-auto max-w-3xl'>
                    ...
                    <ul className='text-xl text-gray-600'>
                        <li>
                            ...
                            Apresentação gráfica dos elementos arquitetônicos e
                            vegetais definidos para as áreas de jardim, assim
                            como as imagens 3D, orientação e sugestões de pontos
                        ...
                        <li>
                            ...
                            jardim - o serviço inclui acompanhamento técnico
                            durante todo o processo, todas as plantas descritas,
                        ...
                        <li>
                            ...
                            <ul className='list-disc px-8 text-xl text-gray-600'>
                                <li>Assinatura de vasos</li>
                                <li>Curadoria de móveis</li>
